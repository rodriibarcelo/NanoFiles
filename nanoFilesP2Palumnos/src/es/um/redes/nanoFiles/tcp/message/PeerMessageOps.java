...
public class PeerMessageOps {
	...
	public static final byte SEND_DOWNLOADFROM = 1;
	public static final byte RECEIVE_DOWNLOADFROM = 2;
	public static final byte FAIL_DOWNLOADFROM = 3;
	...
	private static final Byte[] _valid_opcodes = {
			OPCODE_INVALID_CODE, SEND_DOWNLOADFROM, RECEIVE_DOWNLOADFROM, FAIL_DOWNLOADFROM,



			};
	private static final String[] _valid_operations_str = {
			"INVALID_OPCODE","SEND_DOWNLOAD_FROM", "RECEIVE_DOWNLOAD_FROM","FAIL_DOWNLOAD_FROM"
